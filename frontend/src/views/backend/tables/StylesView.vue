...
<template>
    <!-- Hero -->
    <BasePageHeading title="Table Styles" subtitle="Multiple style options to match your preferences.">
        <template #extra>
            ...
            <div class="col-12">
                ...
                <BaseBlock title="Contextual Table">
                    <table class="table table-borderless table-vcenter table-hover">
                        ...
                        <tbody>
                            <tr v-for="user in users" :key="user.id" :class="`table-${user.rowVariant}`">
                                <th class="text-center" scope="row">
                                    {{ user.id }}
                                </th>
                                <td class="fw-semibold fs-sm">
