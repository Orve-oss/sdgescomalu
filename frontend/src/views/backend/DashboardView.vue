        ...
        <div
            ...
            <div class="flex-grow-1 mb-1 mb-md-0">
                ...
                <h2 class="h6 fw-medium fw-medium text-muted mb-0">
                    Welcome
                    <RouterLink :to="{ name: 'backend-pages-generic-profile' }" class="fw-semibold">John</RouterLink>,
                    ...
                    <div class="col-md-6 col-xl-12">
                        <BaseBlock class="d-flex flex-column h-100 mb-0">
                            <template #content>
                                ...
                                <div class="block-content p-1 text-center overflow-hidden">
                                    <Line :data="totalEarningsData" :options="totalEarningsOptions"
                                        style="height: 90px" />
                                </div>
                            </template>
                        </BaseBlock>
                        ...
                        <BaseBlock class="d-flex flex-column h-100 mb-0">
                            <template #content>
                                ...
                                <div class="block-content p-1 text-center overflow-hidden">
                                    ...
                                    <Line :data="newCustomersData" :options="newCustomersOptions"
                                        style="height: 90px" />
                                </div>
                            </template>
                        </BaseBlock>
