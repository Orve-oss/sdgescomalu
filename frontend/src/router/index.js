...
// Backend: Clients
const BackendClients = () => import("@/views/backend/clients/listClient.vue");
 //Backend: produits
const BackendProduits = () => import("@/views/backend/products/listProduit.vue");
  ...
  */
  {
    ...
    children: [
      ...
      */
      ...
      /*
      |--------------------------------------------------------------------------
      | Backend Blocks Clients Routes
      |--------------------------------------------------------------------------
      */
      {
        path: "blocks",
        redirect: "/blocks/clients",
        children: [
          {
            path: "clients",
            name: "backend-blocks-styles",
            component: BackendClients,
          },
          {
            path: "options",
      ...
      */
      {
        ...
        children: [
          {
            path: "liste",
            name: "backend-elements-liste",
            component: BackendProduits,
          },
          {
            path: "defprix",
            name: "backend-elements-defprix",
            component: BackendDefprix,
          },
          {
            path: "valprix",
            name: "backend-elements-valprix",
            component: BackendValprix,
          },
          {
            path: "entree",
            name: "backend-elements-entree",
